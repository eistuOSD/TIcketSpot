...
JLabel movieTitle1 = new JLabel("TOLKIEN", SwingConstants.CENTER);
...
JLabel movieTitle2 = new JLabel("Farewell Amor", SwingConstants.CENTER);
...
JLabel movieTitle3 = new JLabel("Thor : Love & Thunder", SwingConstants.CENTER);
...
JLabel movieTitle4 = new JLabel("Dune: part one", SwingConstants.CENTER);
...
JLabel movieTitle5 = new JLabel("Aquaman", SwingConstants.CENTER);
...
JLabel movieTitle6 = new JLabel("Freedom: Never push a man too far", SwingConstants.CENTER);
...
JLabel movieTitle7 = new JLabel("JOKER", SwingConstants.CENTER);
...
JLabel movieTitle8 = new JLabel("Star war: Rouge one", SwingConstants.CENTER);
...
JLabel movieTitle9 = new JLabel("Django Unchained", SwingConstants.CENTER);
...
l24 = new JLabel(new ImageIcon(getClass().getResource("/image/minion.jpg")));
moviePanel10.add(l24, BorderLayout.CENTER);
JLabel movieTitle10 = new JLabel("Minions: The Rise of Gru", SwingConstants.CENTER);
...
l26 = new JLabel(new ImageIcon(getClass().getResource("/image/avater.jpg")));
moviePanel12.add(l26, BorderLayout.CENTER);
JLabel movieTitle12 = new JLabel("Avatar: The way of the water", SwingConstants.CENTER);
...
l27 = new JLabel(new ImageIcon(getClass().getResource("/image/jurasic world.jpg")));
moviePanel13.add(l27, BorderLayout.CENTER);
JLabel movieTitle13 = new JLabel("Jurassic World Dominion", SwingConstants.CENTER);
